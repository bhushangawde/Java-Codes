...
class SwingDemo4 extends TimerTask  implements ItemListener  {
...
private void setRem() {
	...
	JTextField jtb1 = new JTextField( "HOUR" , 5);
	...
	jtb1.setFont(font1);
	p2.add(jtb1);
	JTextField jtf1 = new JTextField( "MIN" , 5);
								...
								if(strHOUR.equals(txtHOUR) )
								{
									if(strMIN.equals(txtMIN) )
									{
										...
										//Process proc =r.exec("shutdown -s");
										 try {
											 // Restart system
											 Process proc1 = r1.exec("shutdown -r");
